...
class AddressVerifyReqRespdef(BaseModel):
    """
    Returns the DPS
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["Input", "DPS"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Input": AddressVerifydef.from_dict(obj["Input"]) if obj.get("Input") is not None else None,
            "DPS": obj.get("DPS")
        })
        return _obj
