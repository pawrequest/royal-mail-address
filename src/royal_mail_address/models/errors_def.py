...
class ErrorsDef(BaseModel):
    ...
    resolution: Optional[StrictStr] = Field(default=None, description="Description of the resolution and action required to correct the error")
    __properties: ClassVar[List[str]] = ["code", "description", "cause", "resolution"]
